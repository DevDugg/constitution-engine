...
> *Hidden clues appear in HTML comments.*
...
- **INC‑2025‑11‑03‑01**: n8n job token mismatch → 401s.
  - *Impact*: Delayed distill job.
  - *Mitigation*: Rotate token, update env in n8n.
  - *Prevention*: Add token expiry alarms.
...
- **p50/p95**: __ / __ ms
- **Tokens**: prompt __, completion __
- **Top errors**: E_CONNRESET (x), ZodFail (y)
- **AL distribution**: AL0 __ | AL1 __ | AL2 __ | AL3 __
